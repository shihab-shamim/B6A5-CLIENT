...
import { Calendar, Mail, Lock, Loader2, AlertCircle, User as UserIcon } from "lucide-react";
...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-[85vh] flex items-center justify-center px-4 py-12 relative overflow-hidden">
      ...
      <div className="absolute top-[20%] right-1/4 w-96 h-96 bg-purple-600/20 rounded-full blur-[100px] pointer-events-none" />
      <div className="absolute bottom-[20%] left-1/4 w-96 h-96 bg-blue-600/20 rounded-full blur-[100px] pointer-events-none" />
      ...
      <div className="w-full max-w-md relative z-10">
        <div className="glass-card rounded-2xl border border-slate-700 p-8 shadow-2xl">
          <div className="text-center mb-8">
            ...
            <p className="text-slate-400">Join Planora to host and discover events</p>
          </div>
